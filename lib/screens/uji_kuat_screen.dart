...
class _UjiKuatScreenState extends State<UjiKuatScreen>
  ...
  void _validateInput() {
    ...
    if (_standarAcuan == 'SNI') {
      if (_sisiKubusController.text.isEmpty) {
    ...
    if (_standarAcuan == 'SNI' && _sisiKubusController.text.isNotEmpty) {
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                '📐 Bentuk: Kubus 15×15×15 cm (150×150×150 mm)\n'
                '📏 Luas: Sisi × Sisi = 225 cm²\n'
                '⚖️ Beban: Dalam kg/cm² (langsung dari mesin)\n'
                '🧮 Formula: fc = P / Luas\n'
      ...
      child: Column(
        ...
        children: [
          ...
          if (_standarAcuan == 'SNI' && _result!.sisiKubus != null)
            _buildResultRow(
              'Bentuk Benda Uji',
              'Kubus ${_result!.sisiKubus!.toStringAsFixed(0)}×${_result!.sisiKubus!.toStringAsFixed(0)}×${_result!.sisiKubus!.toStringAsFixed(0)} mm',
              Icons.view_in_ar_rounded,
            )
          ...
          _buildResultRow(
            'Beban Maksimal',
            '${_result!.bebanMaksimal.toStringAsFixed(2)} ${_standarAcuan == "SNI" ? "kg/cm²" : "kN"}',
