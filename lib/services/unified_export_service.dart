            ...
            _pdfInfoBox('Geometri', [
              if (result.standarAcuan == 'SNI' && result.sisiKubus != null) ...[
                ...
                _pdfDetailRow('Dimensi', 
                    '${result.sisiKubus!.toStringAsFixed(0)} × ${result.sisiKubus!.toStringAsFixed(0)} × ${result.sisiKubus!.toStringAsFixed(0)} mm'),
            ...
            _pdfInfoBox('Data Beban', [
              _pdfDetailRow(
                ...
                result.standarAcuan == 'SNI' 
                    ? '${result.bebanMaksimal.toStringAsFixed(2)} kg/cm²'
